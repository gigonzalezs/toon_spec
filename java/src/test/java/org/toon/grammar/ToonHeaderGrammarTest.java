...
class ToonHeaderGrammarTest {
    ...
    private ParseTree parseHeader(String input) {
        ...
        assertTrue(errorListener.errors.isEmpty(), () -> String.join(System.lineSeparator(), errorListener.errors));
        return tree;
    }
    ...
    private static final class CollectingErrorListener extends BaseErrorListener {
        ...
        public void syntaxError(
            ...
            errors.add("línea " + line + ":" + charPositionInLine + " " + msg + " → " + offendingInputSnippet());
        }
